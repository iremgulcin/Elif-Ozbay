...
# -*- coding: utf-8 -*-
#face_classifier = cv2.CascadeClassifier(r'C:\Users\elifo\Desktop\samsung_innovation_campus\emotion_detection\haarcasacade_frontalface_default.xml')
...
while True:
    ...
    for (x, y, w, h) in faces:
        ...
        if np.sum([roi_gray]) != 0:
            ...
            cv2.putText(frame, 'Yüz Yok', (30, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
